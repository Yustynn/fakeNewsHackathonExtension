...
export default class Article {
  constructor(a, fakenessRating, url=null) {
    this.fakenessRating = Math.max(fakenessRating, 0.2);
    this.url = url || a.href;
    this.visited = true;
    ...
    Array.from( fakeNewsNode.querySelectorAll('a') ).forEach( (a) => {
      a.style.color = 'red';
    })
    ...
    if (bar) bar.appendChild(fakeNewsNodeParent.childNodes[0]);
